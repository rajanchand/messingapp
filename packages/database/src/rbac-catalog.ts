...
export const PERMISSIONS = {
  ...
  "reports.read": "View user event reports",
  "reports.manage": "Resolve and delete event reports",
  "media.read": "List homeserver media",
  "media.manage": "Quarantine and delete media",
  "federation.read": "View federation destinations",
  "federation.manage": "Manage federation destination controls",
  ...
  "approvals.read": "View dual-approval / break-glass request queue",
  "approvals.manage": "Approve or reject dual-control requests (second admin)",
} as const;
...
export const SYSTEM_ROLES: SystemRoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: ["audit.read", "security.read", "users.read", "rooms.read", "approvals.read"],
  },
  {
    slug: "user",
    name: "Normal User",
